...
export type ContentItem = {
  ...
  featuredImageId: number | null; featuredImageUrl: string | null; featuredImageAlt: string | null; galleryJson: string; fieldsJson: string; seoTitle: string; seoDescription: string;
